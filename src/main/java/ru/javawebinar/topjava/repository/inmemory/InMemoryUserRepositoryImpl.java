...
public class InMemoryUserRepositoryImpl implements UserRepository {
...

    {
        List<User> users = Arrays.asList(
                new User(null, "Ivan", "ivan@d.com", "123", ROLE_USER, ROLE_ADMIN),
                new User(null, "Petr", "petr@d.com", "345", ROLE_USER, ROLE_ADMIN),
                new User(null, "Alex", "alex@d.com", "678", ROLE_USER, ROLE_ADMIN));
